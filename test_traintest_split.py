"""
Test: SAC N=1, seed 0, with a genuinely separated train/test split.
...
config = {
    ...
    "logging": {"log_dir": "m3_logs/sac_n1_traintest_split_seed1", "tensorboard": True,
                "save_freq": 100_000, "verbose": 1},
}

agent = SACAgent(train_env, config, seed=1)
agent.train()
...
print(f"\n=== TRUE held-out test evaluation (no leakage) ===")
