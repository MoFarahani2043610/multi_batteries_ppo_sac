"""
Test: SAC N=1, seed 4, with a genuinely separated train/test split.
...
config = {
    ...
    "logging": {"log_dir": "m3_logs/sac_n1_traintest_split_seed4", "tensorboard": True,
                "save_freq": 100_000, "verbose": 1},
}

agent = SACAgent(train_env, config, seed=4)
agent.train()
...
print(f"\n=== TRUE held-out test evaluation (no leakage) — SEED 4 ===")
